...
\begin{EntriesTableYear}
  \Year{2024} &
  \Me, \Keith, \Aron .
  \textbf{Expanding materials embeddings for more expressive machine learning models}
  \emph{TYC 7th Energy Materials workshop: form data to discovery of new energy materials, Imperial College London UK}
  \\
  \Year{2023}  &
...
\begin{EntriesTableYear}
  \Year{2024} &
  \Me, \Keith, \Aron.
  \textit{Ionic species representations for materials informatics}
  \newline
  APL Machine Learning [under review] \ChemPreprint{10.26434/chemrxiv-2024-8621l}
  \\
  \Year{2024} &
...
\begin{EntriesTableSkill}
  ...
  \\
  \textbf{Materials Informatics} &  Advacned user of and contributor to  materials informatics packages including \texttt{matminer} and \texttt{pymatgen}.
  \\
  ...
  \\
  \textbf{Other} & User of \texttt{Git} version control, \texttt{GitHub} CI/CD, Slurm, PBs and SGE job scheduling on high performance computing systems, Mac, Linux and Windows operating systems.
\end{EntriesTableSkill}

\section{Awards}

\begin{EntriesTableYear}
  \textbf{2023} & Awarded the Roy Prize for best postgraduate talk at the RSC Solid State Chemistry Group Christmas Meeting.
  \\
\end{EntriesTableYear}
